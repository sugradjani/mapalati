...
DATE_TXT="$(date --rfc-3339=sec | tr ': ' -)"
BACKUP_DIR="${MQW_HOME_DIR}backup/${DATE_TXT}/"
BIN_DIR="${MQW_HOME_DIR}bin/"
DOWNLOADS_DIR="${HOME}/Downloads/"
DOWNLOAD_FILE="${DOWNLOADS_DIR}Pomoć sugrađanima u karantinu - Srbija novi sad.kmz"
